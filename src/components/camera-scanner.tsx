  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className="fixed inset-0 z-50 flex flex-col justify-end sm:grid sm:place-items-center bg-black/85 p-0 sm:p-4 backdrop-blur-md"
      >
        <motion.div
          ...
          className="w-full sm:max-w-xl flex flex-col max-h-[100dvh] sm:max-h-[90vh] rounded-t-3xl sm:rounded-3xl border-t sm:border border-white/15 bg-[#141414] shadow-2xl overflow-hidden"
        >
          {/* Header */}
